...
import QuestionAnswerAddMcq from "../Modules/Admin/Assessments/QuestionAnswerAddMcq";
            ...
            <Banner/>
                <section className="question-management">
                    <div className="container">                       
                        ...
                        <Route exact path={`/admin/question-answer-mcq/add`}><QuestionAnswerAddMcq /></Route>
                        <Route exact path="/admin/question-answer-mcq/edit/:id" component={QuestionAnswerAddMcq}></Route>
