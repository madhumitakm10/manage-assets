...
function TutorList() {
    ...
    const { headerSearch } = useSelector(state => state.nav);

    const [tutors, setTutors]               = useState([]);
    const [loader, setLoader]               = useState(false);
    const [searchTitle,setSearchTitle]      = useState(headerSearch);    
    ...
    useEffect(() => {
        console.log('klm');
        setSearchTitle(headerSearch);
        retrieveAllTutors(limit, offset, sort, headerSearch);
            ...
            <div className="row justify-content-center">
                <div className="col-md-8 col-8">
                    <div className="input-group-append align-items-center">
                        Search : <input type="text" value={searchTitle} className="form-control col-4 search-field3" onChange={onChangeSearchTitle} />
